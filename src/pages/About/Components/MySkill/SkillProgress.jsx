        ...
        <div className="space-y-5">
            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
                <div className="space-y-2">
                    ...
                    <progress className="progress progress-primary bg-gray-50 w-full" value={90} max="100"></progress>
                </div>
                <div className="space-y-2">
                    <div className="flex justify-between font-medium sm:text-lg">
                    ...
                    <progress className="progress progress-primary bg-gray-50 w-full" value={85} max="100"></progress>
                </div>
                <div className="space-y-2">
                    <div className="flex justify-between font-medium sm:text-lg">
                    ...
                    <progress className="progress progress-primary bg-gray-50 w-full" value={80} max="100"></progress>
                </div>
                <div className="space-y-2">
                    <div className="flex justify-between font-medium sm:text-lg">
